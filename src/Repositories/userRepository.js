...
class UserRepository{
        ...
        create(bodyReq){
            ...
            const sqlComand = 'INSERT INTO usuario SET ?;'
        ...
        findAll(){
            const sqlCommand = 'SELECT *  FROM usuario'    
            return new Promise((resolve, reject) =>{
        ...
        findById(id){
            const sqlComand = 'SELECT * FROM usuario WHERE id =?;'
            return  new Promise((resolve, reject) =>{
        ...
        update(bodyReq, id){
            const sqlComand = 'UPDATE usuario SET ? WHERE id = ?;'
            return new Promise((resolve, reject) =>{
        ...
        delete(id){
            const sqlComand = 'DELETE FROM usuario WHERE id = ?;'
            return new Promise((resolve, reject) =>{
                conection.query(sqlComand, id, (erro, result) =>{
                    if(erro)
